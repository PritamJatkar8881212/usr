 ...
 * 
 */
@WebServiceClient(name = "CalculatorServiceService", targetNamespace = "http://calculator/", wsdlLocation = "http://localhost:8080/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICESERVICE_QNAME = new QName("http://calculator/", "CalculatorServiceService");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://calculator/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator/", "CalculatorServicePort"), CalculatorService.class, features);
    }
